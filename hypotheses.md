...
|Bats are just hamster fairies.[[↪]](https://twitter.com/KevinTrethewey/status/1398583096325324801){:target="_blank"}|
|"Gaming the system" is not about trust or no trust. People behave based on the way they perceive they’re measured. It’s an optimisation thing. So best to have metrics that, even if people find shortcuts, make the system better. Or else, for eg, OKRs which focus first on outcome then on metric[[↪]](https://twitter.com/KevinTrethewey/status/1370323396236615681){:target="_blank"}|
